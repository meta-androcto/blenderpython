...
class NA_PT_NodePanel(bpy.types.Panel):
...
class NA_OT_NodeButton(bpy.types.Operator):
...
class NA_OT_NodeButtonOdd(bpy.types.Operator):
...
class NA_OT_NodeButtonCenter(bpy.types.Operator):
